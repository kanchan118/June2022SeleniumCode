...
public class Custom_Xpath {
	...
	public static void main(String[] args) {
		...
		// (//input[@class='form-control'])[last()] //last ele of captured group
		// (//input[@class='form-control'])[last()-1]

		// By help = By.xpath("(//div[@class='navFooterLinkCol
		// navAccessibility']//a)[last()]");
		// (//div[@class='navFooterLinkCol navAccessibility']//a)[last()]
		// (//div[@class='navFooterLinkCol navAccessibility']//a)[last()-1]
...
//		
		...
		//invalid -- NSE no such element exception
		...
		//Backward traversing to top
		//input[@id='username']/../../../../../../../../../..
		
		
		//*[@id='username'] -- 1
		//input[@id='username'] this is faster with html tag
